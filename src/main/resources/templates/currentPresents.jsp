...
<body>
    ...
    <div class="actions">
        <form action="/attendance/currentAbsents">
            <input type="submit" value="Absents">
        </form>
    ...
    <table>
        ...
        <tbody>
            <tr th:each="cdt, status : ${presents}">
                ...
                <td>
                    <div class="action-buttons">
                        <form th:action="@{'/attendance/absent/' + ${cdt[status.index]}}">
